...
<body>
  ...
  <div id="wrapper">
    <div id="main">
      <h2>トップページ</h2>
      <p>家族の未来を応援します！</p>
      <p>ハートの強い子をはぐくむためのコミュニケーション・ベース</p>
      <p>～講演会（学び）+ワークショップ（実践）で、パパ、ママ、キッズもコミュニケーションを学ぼう！～</p>
      <dl>
        <dt>日時</dt>
        <dd>2010年9月5日(日)</dd>
        <dt>場所</dt>
        <dd>大井町きゅりあん（JR/東急大井町駅すぐ）</dd>
        <dt>内容</dt>
        <dd>ワンチケットで講演会+ワークショップが自由に楽しめます（ワークショップは事前登録必要）</dd>
      </dl>
      <p>同伴のお子様は無料でワークショップにご参加いただけます（年齢制限・定員あり）</p>
      <p>同施設内で保育のご用意もあります（別料金・事前予約制）</p>
